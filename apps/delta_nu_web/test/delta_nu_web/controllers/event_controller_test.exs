defmodule DeltaNuWeb.EventControllerTest do
  use DeltaNuWeb.ConnCase

  alias DeltaNu.Events

  @create_attrs %{amount_registered_users: 42, description: "some description", end_time: ~D[2010-04-17], max_registered_users: 42, picture: "some picture", place: "some place", start_time: ~D[2010-04-17], title: "some title"}
